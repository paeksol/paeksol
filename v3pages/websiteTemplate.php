...
<link href="<?php echo $css_root; ?>/bootstrap.css" rel="stylesheet" type="text/css" />
<link href="<?php echo $css_root; ?>/stylesheet.css" rel="stylesheet" type="text/css" />
<link href="<?php echo $css_root; ?>/responsive.css" rel="stylesheet" type="text/css" />
<link href="<?php echo $css_root; ?>/font-awesome.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="<?php echo $js_root; ?>/jquery-latest.min.js"></script>
<script src="<?php echo $js_root; ?>/bootstrap.js" type="text/javascript"></script>
<script src="<?php echo $js_root; ?>/jquery.anchor.js" type="text/javascript"></script>
<!--[if lt IE 9]>
  ...
  <div class="col-md-3 col-sm-3">
   <div class="logo row">
    <a href="javascript:void(0);">
       <img src="<?php echo $img_root; ?>/logo.png" alt="SAFETY FIRST"/>
     </a>
   </div>
  </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true"><img src="<?php echo $img_root; ?>/cross.png" alt="cross"/></span><span class="sr-only">Close</span></button>
      ...
      <div class="errorsHolder topMargin" id="loginErrors">
       ...
       <div class="pop-up-content col-md-12 col-sm-12">
                <form method="POST" id="loginForm" name="loginForm" action="/login">
                  ...
                  <div class="login"><img src="<?php echo $img_root; ?>/face-book.jpg" alt="facebook"/> <span>Login with facebook</span></div>
                  </div>
                  <div class="clearfix"></div></div>
                </form>
      ...
      <div class="modal-footer">
       <div><img src="<?php echo $img_root; ?>/login.png" alt="user" /><a href="javascript:void(0);"  data-target="#myModal3" data-toggle="modal" onclick="$('#myModal').hide();"> Forgot Password ?</a></div>
      </div>
    </div>
  </div>
</div> <!--pop-up 1-->
...
<div class="modal fade pop-up-prp" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
      <!--  <div><img src="<?php echo $img_root; ?>/login.png" alt="user" /> Forgot Password ? <a href="/website/login/forgotten">Click here</a></div> -->
      </div>
    </div>
  </div>
</div> <!--POP-UP-2-->
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li  <?php if($page=="index") : ?>class="active" <?php endif; ?> ><a href="/website/general/show/index">Home</a></li>
         <li <?php if($page=="driver_ed") : ?>class="active" <?php endif; ?>><a href="/website/general/show/driver_ed">Driver's Ed</a></li>
         <li <?php if($page=="behind_the_wheel") : ?>class="active" <?php endif; ?>><a href="/website/general/show/behind_the_wheel">Behind The Wheel</a></li>
         <li <?php if($page=="pricing") : ?>class="active" <?php endif; ?>><a href="/website/general/show/pricing">Pricing</a></li>
         <?php if($this->pixie->auth->service("Student")->user()){ ?>
         <li><a href="/student/dashboard/logout">Logout</a></li>
         <?php } ?>
...
<div class="foot-bott">
 <div class="container">
<p class="pull-left footer-text"><a href="#">&copy;2014 The company  Corporation </a></p>
