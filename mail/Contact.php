...
$message  = '';//"Contact form from ".$_REQUEST['currentpage']."\n\n";
...
mail("info@safetyfirstds.com",$_REQUEST['email'],"Contact Form Submission Received",$message);
...
class Contact {
    ...
    protected function validateFormData($formValidate) {
		...
		echo json_encode("action_process123");
		exit;
