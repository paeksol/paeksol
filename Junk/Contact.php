...
class Contact extends \App\Website\Page {

    public function action_index() {
        $this->setSubview("template");

        $this->view->page_title = 'Contact Us';
        $this->view->page_content = 'This is a test contact us page.';

        $this->view->seo = $this->pixie->seo["contactUs"];
    }
